...
backToList: "Назад к списку",
    ...
    linkPlaceholder: "URL вакансии (начиная с http:// или https://)",
    ...
    notes: "Заметки",
    addNotes: "Добавьте заметки здесь...",
...
backToList: "Back to list",
    ...
    linkPlaceholder: "Job URL (starting with http:// or https://)",
...
backToList: "Zurück zur Liste",
  ...
  de: {
    ...
    linkPlaceholder: "Job-URL (beginnend mit http:// oder https://)",
    ...
    notes: "Notizen",
    addNotes: "Notizen hier hinzufügen...",
    jobLink: "Job-Link",
